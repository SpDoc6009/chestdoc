...
function HomeSidebarNav() {
  return (
    <aside className="hidden rounded-[2rem] border border-[#f2d8cb] bg-[#fdebe2] p-5 shadow-sm lg:sticky lg:top-24 lg:block lg:self-start">
      <p className="text-lg font-semibold text-[#6a716c]">網站導覽</p>
